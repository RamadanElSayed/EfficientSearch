...
//https://www.journaldev.com/14073/android-multi-search-filter-contacts
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView image_search_back = (ImageView) findViewById(R.id.image_search_back);

       // image_search_back.setColorFilter(R.color.text_color);
        //image_search_back.setColorFilter(R.color.colorAccent, PorterDuff.Mode.ADD);
        ...
        edit_text_search.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                if (actionId == EditorInfo.IME_ACTION_SEARCH) {
                    ...
                    recyclerView.setVisibility(View.GONE);
                    ((InputMethodManager) Objects.requireNonNull(getApplicationContext().getSystemService(Context.INPUT_METHOD_SERVICE))).hideSoftInputFromWindow(view_search.getWindowToken(), 0);
